...
Most materials are from [PH525x](https://github.com/genomicsclass/labs/chipseq/ChIPseq.Rmd).
...
We can perform a test by specifying to contrast over the levels of condition. This will call DESeq software (the default, edgeR also available) in order to normalize samples for sequencing depth and perform essentially the same analysis as a differential expression analysis for RNA-Seq counts:
